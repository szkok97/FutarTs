...
export default class Content {
    public content(req: http.IncomingMessage, res: http.ServerResponse): void {
        ...
        res.write(`<p>\tKérem a km-t: <input type='number' name='kilometer' value=${kilometer} style='width:3em;' onChange='this.form.submit();'></p>`);
        res.write(`<p>\t${kilometer}km ${megold.fizetes(kilometer)}Ft-ba kerül</p>`);
